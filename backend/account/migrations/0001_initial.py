# Generated by Django 2.2.13 on 2021-03-07 01:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade', models.CharField(blank=True, default='', max_length=3)),
            ],
        ),
        migrations.CreateModel(
            name='Faculty',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.CharField(max_length=150)),
                ('posted_date', models.DateField(verbose_name=datetime.date(2021, 3, 7))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_taken', models.ManyToManyField(default=0, to='account.Course')),
            ],
        ),
        migrations.AddField(
            model_name='job',
