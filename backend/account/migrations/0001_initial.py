# Generated by Django 2.2.13 on 2021-03-10 02:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applicants', models.ManyToManyField(blank=True, default=0, to=settings.AUTH_USER_MODEL)),
                ('course_req', models.ManyToManyField(blank=True, default=0, to='account.Course')),
                ('poster', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='account.Faculty')),
            ],
        ),
        migrations.AddField(
            model_name='faculty',
